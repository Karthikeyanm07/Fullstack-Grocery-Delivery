						...
						<div className="relative">
							{user ? (
								<button
									...
									onClick={
										() => setUserMenuOpen(!userMenuOpen) // Open/Closes dropdown of user action
									}
								>
							...
							{userMenuOpen && (
								<>
									{/* This below for "If the dropdown is in open when Click anywhere on screen closes dropdown" */}
									<div
										...
										>
											...
											{user && (
												<div className="border-t border-app-border pt-1">
													<button
														className="flex items-center gap-3 py-2.5 px-4 text-sm text-app-error 
