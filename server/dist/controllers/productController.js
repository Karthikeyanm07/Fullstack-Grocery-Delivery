...
import { PRODUCT_WRITE_MAX_ATTEMPTS, PRODUCT_WRITE_WINDOW_MS, } from "../constants/authConstants.js";
import { CreateProductSchema, QuerySchema, UpdateProductSchema, } from "../zod/schemas.js";
// ─── Shared helpers ───────────────────────────────────────────────────────────
// Discount is a derived value — computed here rather than stored in the DB
const attachDiscount = (product) => {
...
const checkProductWriteLimit = async (userId) => {
...
export const getFlashDeals = async (_req, res) => {
    try {
